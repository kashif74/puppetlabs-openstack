...
class openstack (
  ...
  if $use_hiera {
    class { '::openstack::config':
      ...
      keystone_server_fqdn          => hiera(openstack::keystone::server_fqdn, $keystone_server_fqdn),
      keystone_service_name         => hiera(openstack::keystone::service_name, $keystone_service_name),
      keystone_auth_protocol        => hiera(openstack::keystone::keystone_auth_protocol, $keystone_auth_protocol),
    ...
    class { '::openstack::config':
      ...
      keystone_server_fqdn          => $keystone_server_fqdn,
